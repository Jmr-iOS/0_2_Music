...
class LibTableViewHandler : NSObject, UITableViewDataSource, UITableViewDelegate {
...
/************************************************************************************************************************************/
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let cell : LibTableViewCell = self.table.getCell((indexPath as NSIndexPath).item);
